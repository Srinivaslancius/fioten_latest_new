...
function dz_rev_slider_11(){
	...
	if(dzQuery("#dz_rev_slider_11").revolution == undefined){
		revslider_showDoubleJqueryError("#dz_rev_slider_11");
	}else{
		dzrevapi = dzQuery("#dz_rev_slider_11").show().revolution({
			sliderType:"standard",
			jsFileLocation:"//server.local/revslider/wp-content/plugins/revslider/public/assets/js/",
			sliderLayout:"auto",
			dottedOverlay:"none",
